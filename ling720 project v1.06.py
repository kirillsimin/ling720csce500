...
def essayGetGrade(anEssay):
    
    if anEssay[43] != '0.0':
        return float(anEssay[43])
    else:
        return float(anEssay[37])
...
# 
#
#   ###### AVERAGE GRADES FOR ARABIC AND NON-ARABIC ESSAYS ######
#
#
#
...
#     
#     essayGrade = essayGetGrade(anEssay)
# 
#     arabicGrade += essayGrade
#     listGrades.append(essayGrade)
#    
# print('ARABIC GRADES:')
...
#     essayGrade = essayGetGrade(anEssay)
# 
#     nonArabicGrade += essayGrade
#     listGrades.append(essayGrade)
# 
# print('NON-ARABIC GRADES:')    
# print(sorted(listGrades))
