...
arabicQVerbFreq = arabicQVerbs / len(arabicEssays)
nonArabicQVerbFreq = nonArabicQVerbs / len(nonArabicEssays)
...
print('{} arabic essays and {} non-arabic essays'.format(len(arabicEssays),len(nonArabicEssays)))
print()
